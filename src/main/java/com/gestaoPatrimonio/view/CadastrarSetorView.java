 ...
 * @author guilherme
 */
public class CadastrarSetorView extends javax.swing.JFrame {

    /**
     * Creates new form LoginView
     */
    public CadastrarSetorView() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton2.setText("Registrar Setor");
        ...
        jLabel4.setText("Cadastrar setor");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CadastrarSetorView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CadastrarSetorView().setVisible(true);
            }
        });
    }
